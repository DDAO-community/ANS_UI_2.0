...
import { CharacterMetadata } from "./crossbell-metadata";
...
export class NFT {
    ...
    add_poster(poster: string) {
        this.poster = poster;
        return this;
    }
    add_timestamp(timestamp: number) {
    ...
    add_content_type(content_type: string) {
...
// Crossbell stuff goes here

export interface CsbHandle {
    handle: string;
