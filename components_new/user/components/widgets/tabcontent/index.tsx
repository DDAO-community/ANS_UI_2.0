...
export default function Content({
    ...
    const [activity, setActivity] = useState<ArweaveTransaction[]>(
        arkProfile.ARWEAVE_TRANSACTIONS
    );
    ...
    let currentCollection = activity.slice(
        firstIndexCollection,
        indexLastCollection
    );
                        ...
                        NFTs.length - CollectiblePerPage > 0 ? (
                            <article className="flex justify-center mt-12">
                                <button
                                    ...
                                    className="py-2 px-6 btn-primary  text-lg
    ...
    return (
        <>
            ...
            <div className="pb-20">{tabs[selected].component}</div>
        </>
    );
}
