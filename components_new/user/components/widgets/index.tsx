    ...
    if (!arkProfile)
        return (
            <>
                {loading || time ? (
                    <div
                        className="flex items-center justify-center mt-5  flex-col space-y-2
          text-lg text-content-100/80 "
                    >
                        ...
                        <p className="text-sm  text-gray-400">
                            This user has no collection, activity, poaps...
                        </p>
                    </div>
                ) : (
                    <div
                        className="flex flex-col items-center justify-center space-y-2 mt-5
        text-content-100/80 "
                    >
                        <CircularProgress color="inherit" size={40} />
                        <h1 className="text-xl text-gray-400">
                            Retrieving user's assets
                        </h1>
                    </div>
                )}
            </>
